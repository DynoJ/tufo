...
namespace Tufo.Infrastructure.Migrations
{
    ...
    [Migration("20251104154623_AddAreaHierarchy")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tufo.Infrastructure.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Tufo.Infrastructure.Identity.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tufo.Core.Entities.Area", b =>
                {
                    b.HasOne("Tufo.Core.Entities.Area", "ParentArea")
                        .WithMany("SubAreas")
